    ...
    return (
        <Layout>
            <div className="hero">
                ...
                >
                    <h2 className="mobile_title" style={{backgroundColor: "var(--yellow)",}}><Link href="/about">Student</Link></h2>
                    <h2 className="mobile_title" style={{ backgroundColor: "var(--green)", }}><Link href="/skills">Full Stack</Link></h2>
                    <h2 className="mobile_title" style={{ backgroundColor: "var(--blue)", }}><Link href="/projects">Open Source</Link></h2>
                </div>
