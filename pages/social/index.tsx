...
const Socials = () => {
    return (
        <Layout>
                ...
                <div className="social main-card">
                    ...
                    <div>
                        <button className="social-btn">
                            <Link href="/social/github" className="btn-link">
                    ...
                    <div>
                        <button className="social-btn">
                            <Link href="/social/twitter" className="btn-link">
                    ...
                    <div>
                        <button className="social-btn">
                            <Link href="/social/yt" className="btn-link">
                    ...
                    <div>
                        <button className="social-btn">
                            <Link href="/social/web" className="btn-link">
                    ...
                    <div>
                        <button className="social-btn">
                            <Link href="/social/blog" className="btn-link">
                                <svg
                                    role="img"
                                    viewBox="0 0 24 24"
                                    width="24px"
                    ...
                    <div>
                        <button className="social-btn">
                            <Link href="/social/ig" className="btn-link">
                    ...
                    <div>
                        <button className="social-btn">
                            <Link href="/social/mail" className="btn-link">
                                <i className="bi bi-envelope"></i> Public Mail
                            </Link>
                        </button>
                    </div>
                    <div>
                        <button className="social-btn">
                            <Link href="/social/proton" className="btn-link">
                                <svg
                                    role="img"
                                    viewBox="0 0 24 24"
                                    width="24px"
                    ...
                    <div>
                        <button className="social-btn">
                            <Link href="/social/discord" className="btn-link">
                                <i className="bi bi-discord"></i> Discord Server
                            </Link>
                        </button>
                    </div>
                    <div>
                        <button className="social-btn">
                            <Link href="/social/twitch" className="btn-link">
                                <i className="bi bi-twitch"></i> Twitch Streams
                            </Link>
                        </button>
                    </div>
                    <div>
                        <button className="social-btn">
                            <Link href="/social/spotify" className="btn-link">
                                <svg
                                    role="img"
                                    viewBox="0 0 24 24"
                                    width="24px"
                    ...
                    <div>
                        <button className="social-btn">
                            <Link href="/social/stack" className="btn-link">
                                <svg
                                    role="img"
                                    className="svg"
                                    viewBox="0 0 24 24"
            ...
            >
                The above page is a fork of{' '}
                <a
                    href="https://links.noobscience.rocks"
                    target="_blank"
                    rel="noreferrer"
                >
                    Links
