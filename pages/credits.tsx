            ...
            <div className="normalize">
                <div style={{
                    ...
                    <div className="about__div text-div">
                        <p>
                            It all started when I wanted to redesign a old website I made. I wanted to do it
                            with the help of my friends. So, don't ask me how, but it led to us redesigning this
                            website. I'm not the best at designing, but I'm pretty good at coding. So, I did the
                            coding part plus added to the design. Moreover, this website uses some of the most cool and
                        ...
                        <ol>
                            <li>
                                <a href="https://nextjs.org/">Next.js</a> - The React Framework for Production
                            </li>
                            <li>
                                <a href="https://vercel.com/">Vercel</a> - The best hosting platform for Next.js
                            </li>
                            <li>
                                <a href="https://www.figma.com/">Figma</a> - The best design tool
                            </li>
                            <li>
                                <a href="https://mongodb.com">
                                    MongoDB
                                </a> - The NoSQL Database
                            </li>
                            <li>
                                <a href="https://www.npmjs.com/package/react-toastify">
                                    react-toastify
                                </a> - For the cool toasts
                            </li>
                            <li>
                                <a href="https://michalsnik.github.io/aos/">
                                    AOS
                                </a> - For Animating on Scroll
                            </li>
                            <li>
                                <a href="https://animate.style/">
                                    Animate.css
                                </a> - For the cool Animations
                            </li>
                            <li>
                                <a href="https://www.npmjs.com/package/sass">
                                    sass
                                </a> - Because who wants plain css
                            </li>
                        </ol>
                        <h2>
                            Assets
