            ...
            <main>
                ...
                <div className="bod tldr">
                    ...
                    <div style={
                        ...
                        <h2 className="atx" id="tldr">TLDR</h2>
                ...
                <div className="bod">
                    ...
                    <h2 className="atx" id="the-algorithm">The Algorithm</h2>
                    ...
                    <h2 className="atx" id="so-what">So what?</h2>
                    ...
                    <h2 className="atx" id="personal-experience">Personal Experience</h2>
                    ...
                    <h2 className="atx" id="what-can-you-do">What can you do</h2>
