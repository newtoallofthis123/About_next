          ...
          <div className="normalize">
              <div className="full-content-div notes__showcase content-div-yellow">
                  ...
                  <p style={{
                      ...
                      This would be a nightmare to maintain if it was public. Moreover,
                      moderation would be a nightmare. I'm not going to make a
                      registration system for this, so I'm just going to keep it private.
                      So, if you want to see the code snippets, just ask me for the
                        password.
                  </p>
              </div>
          </div>
