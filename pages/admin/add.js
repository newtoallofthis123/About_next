...
export default function NewsAdd() {
    ...
    const addNote = (e) => {
        ...
        }).catch(() => { toast("Error posting Note") })
    }
                            ...
                            mode === 'notes' && (
                                <div>
                                    ...
                                    <form onSubmit={addNote} method="POST">
                                        ...
                                        <p>
                                            <b>Category</b>:
                                            Enter the category of the note.
                                        </p>
                                        <input type="text" name="category" id="category" />
                                        <p>
                                            <b>Content</b>:
                                            Be sure to write the content of the note in Markdown. You can use the preview to see how it will look.
                                        </p>
                                        <textarea onChange={handleContent} value={content} name="content" id="content" rows="20" cols="30"></textarea>
                                        <p></p>
                                        <div>
