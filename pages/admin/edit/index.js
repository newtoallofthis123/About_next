...
export default function EditAdmin() {
  ...
  const handleEditSubmit = (e) => {
    ...
    let link = "";
    if (type === "links") link = e.target.link.value;
    else link = "";
    ...
    <div>
      ...
      {auth ? (
        ...
        <div className="password_div">
          ...
          <p>
            Hey! First off, Hi! Thanks for your interest in the site. I use this
            page for the admin stuff. If you are a hacker, you can try to hack
            me. If you are a friend, you can try to get the password from me.
          </p>
          <p>
            With that said, If you are indeed able to hack into the site, please
            don't do anything bad. I am not a big company, I am just a student
            trying to learn new things. So, just report it to me and I will fix
            it. I have a lot to learn, so please don't be mean.
          </p>
        </div>
      )}
    </div>
