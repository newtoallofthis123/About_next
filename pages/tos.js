    ...
    return (
        <Layout>
            <div style={{textAlign: "justify",}} className="bod">
                ...
                <h2 class="atx" id="tldr-summary">TLDR (Summary)</h2>
                <p>By using our personal blog, you accept and agree to the following terms. We use Nextjs for site functionality, hosting on Vercel, <a href="http://Name.com">Name.com</a> domain service, and cookies to remember your last visit. We also display Google Ads. For legal information, read the advanced section below.</p>
                <h2 class="atx" id="advanced-full-version---legal">Advanced (Full Version - Legal)</h2>
                <h3 class="atx" id="1-introduction">1. Introduction</h3>
                ...
                <h3 class="atx" id="2-nextjs-vercel-and-namecom">2. Nextjs, Vercel, and <a href="http://Name.com">Name.com</a></h3>
                <p>Our Website utilizes Nextjs for site functionality and is hosted by Vercel. Our domain registration services are provided by <a href="%5Bhttp://Name.com%5D(http://Name.com)"></a><a href="http://Name.com">Name.com</a>. By using this Website, you acknowledge and accept the terms and conditions put forth by these third-party service providers.</p>
                <h3 class="atx" id="3-cookies">3. Cookies</h3>
                ...
                <h3 class="atx" id="4-google-ads">4. Google Ads</h3>
                ...
                <h3 class="atx" id="5-modifications-to-terms-of-service">5. Modifications to Terms of Service</h3>
                ...
                <h2 class="atx" id="open-source">Open Source</h2>
                <p>This blog and personal portfolio site is in itself open source and the code is available on <a href="/social/github"></a><a href="http://github.com">github.com</a> under the MIT License. You are free to use the code as you see fit. But the content is copy righted to us and you are not allowed to modify or distribute it in anyway possible. You are free to share it and copy it as you see fit</p>
