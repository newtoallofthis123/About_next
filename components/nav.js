    ...
    return (
        <>
            ...
            <nav className="nav-normal">
                <ul>
                    {/* eslint-disable-next-line */}
                    <li className="nav-title"><img src={icon.src} width="36" style={{ verticalAlign: "middle", borderRadius: "24px" }} alt="NoobScience Icon" /> <span role="button" onClick={() => { navigate("/") }}>NoobScience</span></li>
                    <>
                        <li>
                            <Link href="/about" className="underline">About</Link>
                        </li>
